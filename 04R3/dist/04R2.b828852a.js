...
function showResultGrid() {
    ...
    allTypes.forEach((type)=>{
        ...
        if (type.name === selectedType) card.classList.add("selected");
...
function initializeSSE() {
    ...
    es.onmessage = (event)=>{
        ...
        if (data.types) {
            ...
            if (!voted) {
                for (const type of allTypes)if (type.users.includes(USER_ID)) {
                    voted = true;
...
},{}]},["93v64","lhpGb"], "lhpGb", "parcelRequire0f0c", {})
